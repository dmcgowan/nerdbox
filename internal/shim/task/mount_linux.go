...
func setupMounts(ctx context.Context, id string, m []*types.Mount, rootfs, lmounts string, blobsDir string, da *diskAllocator) ([]*types.Mount, []sandbox.Opt, error) {
	// Handle mounts
	...
	mounts, opts, err := transformMounts(ctx, id, m, blobsDir, da)
